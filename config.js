...
const { cosplay, mountain, dynamic, flamming, galau, estetik, waifu, boneka } =
  ...
  try {
    colors.setTheme({
      ...
      (global.APIs = {
        ...
        proxy: pickRandom(proxyUrl),
      }),
      (global.APIKeys = {
        "https://api.neoxr.eu": pickRandom(["5VC9rvNx", "lucycat"]),
        "https://api.lolhuman.xyz": pickRandom([
          "043c5de3b7cd6b1b8f2a0f90",
          "e1a815979e6adfc071b7eafc",
      ...
      (global.sgc = "https://s.id/gc-taylor"),
      ...
      (global.sukses = pickRandom(["✨", "🌟", "🎉", "🥳", "✅", "👍"])),
      (global.render = pickRandom([
        "_*`Rendering 📍`*_",
        "_*`Processing 📍`*_",
        "_*`Generating content 📍`*_",
      ])),

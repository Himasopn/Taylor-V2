...
const handler = async (m, {
  ...
  try {
    db.data.chats[m.chat], Object.entries(APIKeys).find(([key]) => key.includes('lolhuman'))?.[1], args[0], await (await axios.get(`https://tinyurl.com/api-create.php?url=${args[0]}`)).data;
